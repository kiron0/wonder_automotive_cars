    ...
    <div className="container mx-auto ">
      ...
      <div>
        ...
        <div className="blog-info">
          <div>
            <h2 className="text-primary fs-4 fst-italic font-normal">
              {" "}
              NodeJS :{" "}
            </h2>
            <p>
      ...
      <div>
        <h2 className="fw-normal text-3xl text-center my-5 fst-italic font-normal">
        ...
        <div className="blog-info">
          ...
          <div>
            ...
            <p className="mt-2">
              Micro-Services-based architecture lets you split your application
